        ...
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            {/* <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/students">{props.t("Student List")}</Link>
                </li>
                <li>
                  <Link to="/students/create">{props.t("Create Student")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/teachers">{props.t("Teachers List")}</Link>
                </li>
                <li>
                  <Link to="/teachers/create">{props.t("Create Teacher")}</Link>
                </li>
              </ul>
            </li> */}
            <Permission permission={["view-role", "view-user"]}>
              <li>
                <Link to="/#" className="has-arrow">
                ...
                <ul className="sub-menu" aria-expanded="false">
                  <Permission permission="view-role">
                    <li>
                      <Link to="/roles">{props.t("Roles")}</Link>
                    </li>
                  </Permission>
                  <Permission permission="view-user">
                    <li>
            ...
            <Permission permission={["view-examboard", "view-keystage", "view-year"]}>
              <li>
                <Link to="/#" className="has-arrow">
                  <i className="fa fa-graduation-cap"/>
                  <span>{props.t("Learning Management")}</span>
                </Link>
                <ul className="sub-menu" aria-expanded="false">
                  <Permission permission="view-examboard">
                    <li>
                      <Link to="/exam-board">{props.t("Exam Boards")}</Link>
                    </li>
                  </Permission>
                  <Permission permission="view-keystage">
                    <li>
                      <Link to="/key-stages">{props.t("Key Stages")}</Link>
                    </li>
                  </Permission>
                  <Permission permission="view-year">
                    <li>
                      <Link to="/years">{props.t("Years")}</Link>
                    </li>
                  </Permission>
                </ul>
              </li>
            ...
            <Permission permission={["view-subject", "view-chapter", "view-lesson"]}>
              <li>
                <Link to="/#" className="has-arrow">
                  <i className="bx bx bx-book"/>
                  <span>{props.t("Learning")}</span>
                </Link>
                <ul className="sub-menu" aria-expanded="false">
                  <Permission permission="view-subject">
                    <li>
                      <Link to="/subjects">{props.t("Subjects")}</Link>
                    </li>
                  </Permission>
                  <Permission permission="view-chapter">
                    <li>
                      <Link to="/chapters">{props.t("Chapters")}</Link>
                    </li>
                  </Permission>
                  <Permission permission="view-lesson">
                    <li>
                      <Link to="/lessons">{props.t("Lessons")}</Link>
                    </li>
                  </Permission>
                </ul>
              </li>
            </Permission>
            <Permission permission={["create-qa", "view-qa", "update-qa", "delete-qa"]}>
              <li>
                <Link to="/questions">
                  <i className="mdi mdi-comment-question"/>
                  <span>{props.t("Q&A")}</span>
                </Link>
              </li>
            </Permission>
            <Permission permission={["view-selftest"]}>
              <li>
                <Link to="/self-test">
            ...
            <Permission permission={["view-worksheet"]}>
              <li>
                <Link to="/worksheet">
            ...
            <Permission permission={["view-pastpaper"]}>
              <li>
                <Link to="/pastpaper">
            ...
            <Permission permission={["view-plan", "create-plan"]}>
              <li>
                <Link to="/#" className="has-arrow">
                  <i className="bx bxs-package"/>
                  <span>{props.t("Plan and Prices")}</span>
                </Link>
                <ul className="sub-menu" aria-expanded="false">
                  <Permission permission="view-plan">
                    <li>
                      <Link to="/plan-and-prices">{props.t("Plans")}</Link>
                    </li>
                  </Permission>
                  <Permission permission="create-plan">
                    <li>
                      <Link to="/plan-and-prices/create">{props.t("Create Plan")}</Link>
                    </li>
                  </Permission>
                </ul>
              </li>
